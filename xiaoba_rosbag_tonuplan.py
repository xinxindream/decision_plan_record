...
class process_rosbag(object):
    ...
    def run(self):
        ...
        for i in range(self._num_past_poses+self._drop_start_frames, len(agents_list) - self._num_future_poses - self._drop_end_frames):
            ...
            # train_set, valid_set = train_test_split(data, train_size=0.9)

            # append data
            self._save_data.append(data)
            # # # save to disk
            # self.save_to_disk(self._save_path, data)
            # self.save_to_disk(self._save_path + 'train/', train_set)
            # self.save_to_disk(self._save_path + 'valid/', valid_set)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--bag_path', type=str, help='path to bag', default="/data/datasets/xiaoba/2024.1.11/2024-01-11-17-20-37_part1_with_det_2.bag")
    parser.add_argument('--save_dir', type=str, help='path to save',
                        default="/data/datasets/xiaoba/2024.1.11/2024-01-11-17-20-37_part1_with_det_2_train/")
